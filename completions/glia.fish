...
complete -c glia -n __glia_first -a '-D'          -d 'dice roll, RPG notation (2d6, 1d100+4) - no AI'
complete -c glia -n __glia_first -a '--dice'      -d 'dice roll, RPG notation (long form of -D)'
complete -c glia -n __glia_first -a '-R'          -d 'random number (-R 100 / -R 5-50) - no AI'
complete -c glia -n __glia_first -a '--random'    -d 'random number (long form of -R)'
complete -c glia -n __glia_first -a '-X'          -d 'calculator, awk arithmetic - no AI'
complete -c glia -n __glia_first -a '--calc'      -d 'calculator (long form of -X)'
complete -c glia -n __glia_first -a '--conv'      -d 'unit converter (100 mi km, 90 f c, 1 gib mb) - no AI'
complete -c glia -n __glia_first -a '--days'      -d 'days until/since a date, or between two - no AI'
complete -c glia -n __glia_first -a '--pw'        -d 'password/uuid from /dev/urandom - no AI'
complete -c glia -n __glia_first -a '--pick'      -d 'draw from a list (--pick a b c) - no AI'
complete -c glia -n __glia_first -a '--tools'     -d 'the green toolbox, on one page'
